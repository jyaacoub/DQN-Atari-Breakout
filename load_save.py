...
class DeepQNetwork(object):
    ...
    def __build_model(num_actions:int) -> tf.keras.Model:
        ...
        model = tf.keras.models.Sequential([
            tf.keras.layers.Conv2D(32, (8,8), activation='relu', strides=4, use_bias=False, input_shape=(84,84,4), name="Hidden_layer_1"),
            tf.keras.layers.Conv2D(64, (4,4), activation='relu', strides=2, use_bias=False, name="Hidden_layer_2"),
            tf.keras.layers.Conv2D(64, (3,3), activation='relu', strides=1, use_bias=False, name="Hidden_layer_3"),
            tf.keras.layers.Conv2D(1024, (7,7), activation='relu', strides=1, use_bias=False, name="Hidden_layer_4"),
            tf.keras.layers.Flatten(name="Final_flatten"),
...
dqn = DeepQNetwork(4)
dqn.Model.load_weights('dqn_model_atari_weights.h5')